 ...
 * Sec: 2
 * 
 * MobileDeviceComplete class creates a full mobile device information form.
 * Users can enter device details,
 * select options for device type, OS, and rate the device.
 * 
...
import potjanapimol.pattaraporn.lab9.ReadImage;
...
public class MobileDeviceComplete extends JFrame {
    ...
    protected JMenuItem newMI, openMI, saveMI, exitMI, smallMI, mediumMI, largeMI, xLargeMI, blackMI, redMI, greenMI,
            blueMI, font1MI, font2MI, font3MI;
    protected JPanel mainPanel, topPanel, middlePanel, bottomPanel, rbPanel, dbPanel, TAPanel, listPanel, sliderPanel,
            imagePanel, buttonPanel;
